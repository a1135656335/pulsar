 ...
 */
public class AuthenticationXzzh implements Authentication, EncodedAuthenticationParameterSupport {

  private static final long serialVersionUID = 434496553179093325L;
  private Supplier<String> tokenSupplier = null;

  public AuthenticationXzzh() {}

  public AuthenticationXzzh(String token) {
    this(new SerializableTokenSupplier(token));
  }

  public AuthenticationXzzh(Supplier<String> tokenSupplier) {
  ...
  public AuthenticationDataProvider getAuthData() {
    return new AuthenticationDataXzzh(tokenSupplier);
  }
  ...
  public void configure(String encodedAuthParamString) {
    ...
    if (encodedAuthParamString.startsWith("token:")) {
      this.tokenSupplier =
          new SerializableTokenSupplier(encodedAuthParamString.substring("token:".length()));
